...
namespace TanvirArjel.EFCore.GenericRepository
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        /// <summary>
        ///     Registers an <see cref="IQueryRepositoryFactory{TDbContext}" /> in the <see cref="IServiceCollection" /> to create instances
        ///     of given <see cref="IQueryRepository{TDbContext}" /> type.
        /// </summary>
        /// <remarks>
        ///     <para>
        ///         Registering a factory instead of registering the reposiotry type directly allows for easy creation of new
        ///         <see cref="IQueryRepository{TDbContext}" /> instances.
        ...
        ///         For applications that don't use dependency injection, consider creating <see cref="IQueryRepository{TDbContext}" />
        ...
        public static IServiceCollection AddQueryRepositoryFactory<TDbContext>(
            this IServiceCollection services,
            ...
            where TDbContext : DbContext
        {
            ...
            services.Add(new ServiceDescriptor(
                typeof(IQueryRepositoryFactory<TDbContext>),
                typeof(QueryRepositoryFactory<TDbContext>),
                lifetime));
